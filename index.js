        ...
        var returnFun =(function ($,KRPerfectScrollbar) {
            ...
            var helpers = {
                ...
                'formatDate': function (date) {
                    ...
                    return helpers.formatAMPM(d) + ", " + d.toDateString().slice(4,10);
                },
        ...
        function updateOnlineStatus() {
            ...
            chatWindow.prototype.init = function () {
                ...
                if(!me.config.minimizeMode){
                    ...
                    chatWindowHtml.find('.minimized-title').html;
                    me.skipedInit=true;
                ...
                me.i18n={
                    ...
                    langFiles:{
                        en: {
                            ...
                            //entertosend: "Type your message here...",
							entertosend: "",
            ...
            chatWindow.prototype.seti18n = function (lang) {
                ...
                botMessages.selectedLanguage=me.i18n.selectedLanguage;
                 ...
                 if(me.config.chatContainer){
					...
					chatEle.find('.download-transcript').attr('title',botMessages.downloadText);
			...
			/*Button template custom events
			
			chatWindow.prototype.buttonTemlpateEvents = function (messageHtml, msgData) {
				$(messageHtml).find(".buttonTmplContent").on('click', function (e) {

			console.log("button");
			//$(".buttonTmplContent").remove();
            $(".fromOtherUsers with-icon").remove();
		});
				
			};
			
			Button template custom events end*/
            ...
            chatWindow.prototype.bindEvents = function () {
                ...
                /*_chatContainer.draggable({
					...
					handle: _chatContainer.find(".kore-chat-header .header-title"),
					handle: _chatContainer.find(".kore-chat-header .header-img"),
                    ...
                    */
                    _chatContainer.off('click', '.download-transcript').on('click', '.download-transcript', function (event) {
                     let link_url= KoreSDK.chatConfig.botOptions.hostUrl+"?visitorId="+KoreSDK.chatConfig.botOptions.userId
                     me.openExternalLink(link_url)
                    });
                    /* end */
				...
				/*_chatContainer.off('keyup', '.chatInputBox').on('keyup', '.chatInputBox', function (event) {
                    ...
                    // if (event.keyCode !== 13) {
                    //     let inputBoxPayload = $(".chatInputBox")[0].innerText
                    //     var messageToBot = {};
                    //     messageToBot["clientMessageId"] = new Date().getTime();
                    //     messageToBot["event"] = "START_TYPING";
                    //     messageToBot["message"] = {
                    //         "body": "",
                    //         "type": "START_TYPING"
                    //     }
                    //     messageToBot["resourceid"] = "/bot.message";
                    //     //chatWindowInstance.bot.sendMessage(messageToBot);
                ...
                _chatContainer.off('keyup', '.chatInputBox').on('keyup', '.chatInputBox', function (event) {
                    ...
                    var agentStatus = localStorage.getItem("agentConnected");
                    
                    if (event.keyCode !== 13 && ((event.which <= 90 && event.which >= 48) || (event.which >= 96 && event.which <= 105) || (event.which >= 186 && event.which <= 222) || (event.keyCode === 32 || event.keyCode === 8)) && (agentStatus && agentStatus=='true')) {
                    ...
                    messageToBot["customEvent"] = "START_TYPING";
                    ...
                    typingTimer = setTimeout(() => sendStopTypingEvent(), stopTypingInterval);
                    ...
                    messageToBot["customEvent"] = "STOP_TYPING";
                ...
                _chatContainer.off('click', '.buttonTmplContentBox li,.listTmplContentChild .buyBtn,.viewMoreList .viewMore,.listItemPath,.quickReplyDiv,.carouselImageContent,.listRightContent,.checkboxBtn,.likeDislikeDiv').on('click', '.buttonTmplContentBox li,.listTmplContentChild .buyBtn, .viewMoreList .viewMore,.listItemPath,.quickReplyDiv,.carouselImageContent,.listRightContent,.checkboxBtn,.likeDislikeDiv', function (e) {
                    ...
                    if (e.currentTarget.classList && e.currentTarget.classList.length > 0 && e.currentTarget.classList[0] === 'quickReply') {
                        ...
                        setTimeout(function () {
                            ...
                            $('.quick_replies_btn_parent').remove();
                        }, 50);
                    }
                    setTimeout(function () {
                ...
                _chatContainer.off('click', '.close-btn').on('click', '.close-btn', function (event) {
                    $("#overlayEndConversation").removeClass("hide");
                    $("#overlayEndConversation").addClass("show");
                });
                _chatContainer.find("#showConfirmationModal").on('click', function (event) {

                    $("#overlayEndConversation").removeClass("show");
                    $("#overlayEndConversation").addClass("hide");
                
                });
                _chatContainer.find("#resetConversation").on('click', function (eevnt) {

                    var messageToBot = {};
                        messageToBot["message"] = {body:"closeconversationsessionbyuser"};
                        messageToBot["resourceid"] = '/bot.message';
                    ...
                    messageToBot["customEvent"] = "CLOSE_CONVERSATIONSESSION_BY_USER";
                    ...
                    location.href = KoreSDK.chatConfig.botOptions.closeWindow;
                ...
                _chatContainer.off('click', '.retry').on('click', '.retry', function (event) {
					...
					_chatContainer.find(".download-btn").trigger('click',{isDownload:true});
                });
				...
				_chatContainer.off('click', '.download-btn').on('click', '.download-btn', function (event,data) {
                    //_chatContainer.off('click', '.download-transcript').on('click', '.download-btn', function (event,data) {
            ...
            chatWindow.prototype.bindSDKEvents = function (){
                ...
                me.bot.on("message", function (message,e) {
                    ...
                    if (tempData.from === "bot" && tempData.type === "bot_response") {
                        ...
                        if (tempData.message[0]) {
                            ...
                            if(tempData.message[0].component && ((tempData.message[0].component.payload.template_type == "date_templatedob") || (tempData.message[0].component.payload.template_type == "date_templatemove")||(tempData.message[0].component.payload.template_type == "date_templatemoveout")|| (tempData.message[0].component.payload.template_type == "date_template") || (tempData.message[0].component.payload.template_type == "date_templatepayment") || (tempData.message[0].component.payload.template_type == "form_AddressConfirmMoveFull") ||(tempData.message[0].component.payload.template_type == "form_paymentArrangement")||(tempData.message[0].component.payload.template_type == "form_AddressConfirmMove")||(tempData.message[0].component.payload.template_type == "customCaptchaTemplate")||(tempData.message[0].component.payload.template_type == "mfauserMsgTemplate")||(tempData.message[0].component.payload.template_type == "mfaOTPMsgTemplate")||(tempData.message[0].component.payload.template_type == "mfauserPhoneMsgTemplate")||(tempData.message[0].component.payload.template_type == "mfaOTPEmailMsgTemplate")||(tempData.message[0].component.payload.template_type == "reset_chatwindow") ||(tempData.message[0].component.type == "template_disable"))){
            ...
            chatWindow.prototype.onBotReady = function (){
				...
				_chatContainer.find('.kore-chat-header .header-img');
            ...
            chatWindow.prototype.sendMessage = function (chatInput, renderMsg,msgObject) {
				...
				var agentConnectionStatus = localStorage.getItem("agentConnected")
                    if(!agentConnectionStatus || agentConnectionStatus === "false"){
                        $('.typingIndicatorContent').css('display', 'block');
                        if(me.typingIndicatorTimer){
                            clearTimeout(me.typingIndicatorTimer);
                        }
            ...
            chatWindow.prototype.renderMessage = function (msgData) {
                ...
                messageHtml = me.customTemplateObj.renderMessage(msgData);
                 /* Added agent_status && display_indicator Templates - Enbridge - 18-11-2022 */
                    if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "agent_status") {// to show typing indicator until next response receive
                        if(msgData.message[0].component.payload.isConnected){
                            localStorage.setItem("agentConnected", true);
                        }else{
                            localStorage.setItem("agentConnected", false);
                            $('.typingIndicator').removeClass("from-agent");
                        }
                        return;
                    } else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "display_indicator") {// to show typing indicator until next response receive
                        if(msgData.message[0].component.payload.isTyping){
                            $('.typingIndicator').addClass("from-agent");
                            $('.typingIndicatorContent').css('display', 'block');
                        }else{
                    ...
                    /** End */
				else if (messageHtml === '' && msgData && msgData.message && msgData.message[0]) {
                    ...
                    if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "button") {
						...
						//this.buttonTemlpateEvents(messageHtml, msgData);
                    }
            ...
            <div class = "kore-chat-overlay hide" id="overlayEndConversation">\
            <div><p>Are you sure you want to end this conversation?</p>\
                <button id="resetConversation" tabindex="3" >Yes</button>\
                <button id="showConfirmationModal" tabindex="4">No</button>\
            </div>\
            </div>\
            <div class="kr-wiz-menu-chat defaultTheme-kore">\
                    ...
                    <div class="kore-chat-header"> \
						<div id="botHeaderImg" aria-labelledby="botHeaderImg" class="header-img" title="${chatImg}">${chatImg}</div> \
                        ...
                        <div class="chat-box-controls"> \
                            ...
                            {{/if}}\
                            <button class="download-transcript" title="${botMessages.downloadText}"></button>\
                    ...
                    <div role="log" aria-live="polite" aria-atomic="true" class="kore-chat-body" style="margin-bottom:15%;"><b style="color:red;text-align:center;"><center style="margin-top:10px;"><i>Connect With Us!&nbsp;&nbsp;</i></b></center><br/><center><a href="https://ca.linkedin.com/company/enbridgegas" target="_blank"style="padding-bottom:5px;"><img src="data:image/png;base64," ></img></a>&nbsp;<a href="https://www.instagram.com/enbridgegas/" target="_blank" style="padding-bottom:5px;"><img src="data:image/png;base64," ></img></a>&nbsp;<a href="https://www.facebook.com/enbridgegas/" target="_blank"style="padding-bottom:5px;"><img src="data:image/png;base64," ></img></a>&nbsp;<a href="https://x.com/enbridgegas" target="_blank" style="padding-bottom:5px;"><img src="data:image/png;base64," ></img></a>&nbsp;</center> \
			<div class="errorMsgBlock"> \
                    ...
                    <div class="kore-chat-footer disableFooter">' + chatFooterTemplate + '{{if isSendButton}}<div class="sendBtnCnt"><button class="sendButton disabled" type="button"><img src="data:image/svg+xml;base64,"></button></div>{{/if}}</div> \
                        ...
                        {{each(key, msgItem) msgData.message}} \
                            {{if msgItem.cInfo && msgItem.type === "text"}} \
                                <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                                    ...
                                    {{if msgData.createdOn}}<div aria-hidden="true" aria-live="off" class="extra-info">{{if msgData.type === "bot_response"}}{{if msgData.fromAgent}}Agent- ${helpers.formatDate(msgData.createdOn)} {{else}}ChatBot- ${helpers.formatDate(msgData.createdOn)} {{/if}} {{else}}You- ${helpers.formatDate(msgData.createdOn)}{{/if}}</div>{{/if}} \
                ...
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        ...
                        <div class="buttonTmplContent"> \
                            {{if msgData.createdOn}}<div aria-hidden="true" aria-live="off" class="extra-info">{{if msgData.type === "bot_response"}}Chatbot- ${helpers.formatDate(msgData.createdOn)} {{else}}You- ${helpers.formatDate(msgData.createdOn)}{{/if}}</div>{{/if}} \
        ...
        var quickReplyTemplate = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon"> \
                        <div class="buttonTmplContent"> \
                            {{if msgData.createdOn}}<div aria-live="off" class="extra-info">Chatbot- ${helpers.formatDate(msgData.createdOn)}</div>{{/if}} \
                            {{if msgData.icon}}<div aria-live="off" class="profile-photo"> <div class="user-account avtar" style="background-image:url(${msgData.icon})"></div> </div> {{/if}} \
                                ...
                                <div class="fa fa-chevron-left quickreplyLeftIcon hide"></div><div class="fa fa-chevron-right quickreplyRightIcon hide"></div>\
                                    <div class="quick_replies_btn_parent"><div class="autoWidth">\
                                        {{each(key, msgItem) msgData.message[0].component.payload.quick_replies}} \
                                            <div class="buttonTmplContentChild quickReplyDiv" {{if msgItem.payload}}value="${msgItem.payload}"{{/if}} type="${msgItem.content_type}"> <span class="quickReply {{if msgItem.image_url}}with-img{{/if}}">\
     ...
     var iframe = '<script id="chat_message_tmpl" type="text/x-jquery-tmpl"> \
            ...
            function disableChat(disable){
                ...
                if(disable){
                    ...
                    $('.chatInputBox').blur();
                    //$('.kore-chat-footer').addClass('disable');
                    //$('.kore-chat-footer').blur();
                    
                }
                else{
                    $('.chatInputBox').removeClass('disable');
                    $('.chatInputBox').attr("contenteditable",true);
                    //$('.kore-chat-footer').removeClass('disable');
                }
            };
            ...
            this.show = function (cfg) {
                ...
                chatInitialize.customTemplateObj = new customTemplate(cfg,chatInitialize,bot);
           ...
           /* $(window).on('beforeunload', function () {
            ...
            function onComponentReady(_this, data) {
                ...
                console.log("function onComponentReady");
                $('.chatInputBox').focus();
